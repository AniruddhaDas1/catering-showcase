      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-2xl font-bold tracking-tight">
            <span data-brand-text="business-name">Saveur</span> <span className="text-primary">&amp; Co.</span>
          </span>
        </Link>
        ...
        <Link
          to="/contact"
          className="hidden rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground transition hover:opacity-90 md:inline-block"
        >
          Book us
        </Link>
        <button
    ...
    <footer className="border-t border-border bg-secondary/40">
      <div className="mx-auto grid max-w-6xl gap-8 px-6 py-12 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-bold" data-brand-text="business-name">Saveur &amp; Co.</span>
          </div>
          <p className="mt-3 text-sm text-muted-foreground">
            Chef-driven catering for weddings, corporate & private events in Brooklyn and beyond.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>hello@saveurandco.com</li>
            <li data-brand-text="phone">(718) 555-0142</li>
            <li data-brand-text="address">221 Kent Ave, Brooklyn NY</li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-6xl px-6 py-4 text-xs text-muted-foreground">
          ...
          © 2026 Saveur &amp; Co. Catering · All rights reserved.
        </div>
